...
Prefix") einen Namensraum zu, in welchem das Unternehmen selbst IDs
...
dem die zugehörige Basisnummer gehört, ohne dass ein Online-Lookup in einer
...
wie dem GS1 DataMatrix kodiert und deren Vertrauenswürdigkeit offline verifiziert
werden.
